...
ESP32Encoder myEnc; // Použití ESP32Encoder pro ESP32
...
void setup() {
  ...
  myEnc.attachFullQuad(27, 26);  // Piny pro enkodér (DT a CLK)
  rtc.initClock();
  rtc.setTime(1,59,0);
  boot();
}
...
void setTimer() {
  ...
  // Inicializace stavu tlačítka a enkodéru
  long lastPosition = myEnc.getCount();
  bool buttonPressed = false;
